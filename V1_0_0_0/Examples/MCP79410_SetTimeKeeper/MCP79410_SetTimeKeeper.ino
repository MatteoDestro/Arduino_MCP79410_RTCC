...
#
#  =============================================================================
#  This is an example that shows how to set the TimeKeeper of the MCP79410 device (RTCC - Real Time Clock Calendar)
...
#
#  - MCP79410_SetTimeKeeper -> Main file project
#  - RTCC_Settings          -> Contains code to manage RTCC settings (TimeKeeper)
...
#  Run the MCP79410_SetTimeKeeper.ino file from your Arduino IDE.
#
#  SUPPORT
#  
